...
<div class="big-container">
    ...
    <article class="post articles postnohover">
      <div class="postimg">
        <img src="/images/portfolio/ExpertExpress.png" />
      </div>
      <div class="padding">
        <!-- <h1><a target="_blank" href="http://keillasik.com/">Keil Lasik</a></h1> -->
        <div class="entry">
          <p>Service experts in heating, air conditioning, plumbing and electric.</p>
          <ul>
            <li>Content Marketing</li>
            <li>Search Engine Optimization</li>
            <li>Pay Per Click Management</li>
